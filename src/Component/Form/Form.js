...
class Form extends Component {
    ...
    onSubmitMessage = () => {
        ...
        if(document.querySelector('#formGroupExampleInput').value === '') {
            ...
            fetch('https://quiet-temple-48121.herokuapp.com/message', {
            method: 'put',
            ...
            <div>
                ...
                <div className="d-flex justify-content-center">
                    ...
                    <form className="py-5 px-5 rounded shadow mb-5">
                        ...
                        <button type="button" className="btn btn-primary btn-lg btn-block" onClick={this.onSubmitMessage}><span onClick={this.onClick}>Submit</span></button>
                    </form>
                </div>
